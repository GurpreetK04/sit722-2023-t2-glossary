...
const glossaryData = [
  ...
  },
  {
...

   {
     ...
     description: 'An Artifact Repository is a centralized location for storing and managing software artifacts, such as binary files, libraries, and dependencies. It plays a critical role in DevOps for versioning and sharing artifacts across the software development and deployment lifecycle.',
     reference: 'https://www.jfrog.com/confluence/display/JFROG/Repository',
   },

  {
    term: 'Terraform Provider',
    description: 'A Terraform provider is a plugin that allows Terraform to interact with specific APIs or services, enabling the creation, management, and deletion of resources in those services. Providers are used to extend Terraforms capabilities to various platforms.',
    reference: 'https://www.terraform.io/docs/providers/index.html',
  },

  {
    term: 'Service Mesh',
    description: 'A Service Mesh is a dedicated infrastructure layer that handles communication and network interactions between microservices. It provides features like load balancing, security, and observability to microservices-based applications.',
    reference: 'https://istio.io/latest/docs/concepts/what-is-istio/',
  },

  {
    term: 'Zero Trust Security Model',
    description: 'The Zero Trust Security Model is an approach where no entity, whether inside or outside the network, is trusted by default. DevOps teams use this model to enhance security by verifying and validating every access request.',
    reference: 'https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-207.pdf',
  },

  {
    term: 'GitOps',
    description: 'GitOps is a DevOps practice where the entire infrastructure and application state is stored in a Git repository. Changes to the infrastructure are managed through Git commits and are automatically applied to the environment.',
    reference: 'https://www.weave.works/technologies/gitops/',
  },

  {
    term: 'Secret Management',
    description: 'Secret Management involves securely storing, accessing, and distributing sensitive information such as passwords and API keys. DevOps teams use secret management tools to protect sensitive data in their workflows.',
    reference: 'https://www.hashicorp.com/resources/secrets-management',
  },

  {
    term: 'Immutable Infrastructure',
    description: 'Immutable Infrastructure is an approach where infrastructure components, such as servers, are never modified after their initial setup. Instead, when changes are required, new instances are created and the old ones are replaced. This approach improves consistency and reduces configuration drift.',
    reference: 'https://www.hashicorp.com/resources/what-is-immutable-infrastructure',
  },

  {
    term: 'Containers',
    description: 'Containers are a standardized packaging format that encapsulates all the necessary components to run software, including the application code and its dependencies. They provide a consistent and reliable way to execute applications across diverse computing environments.',
    reference: 'https://www.docker.com/resources/what-container',
  },

  {
    term: 'Rollback',
    description: 'Rollback is a DevOps process that involves reverting to a previous version of a software application or system configuration in case of issues or failures. It is used to restore stability and functionality to the system by undoing recent changes.',
    reference: 'https://dev.to/rhymu8354/the-devops-handbook-by-gene-kim-2e4a',
  },

  {
    term: 'Mean Time to Recovery (MTTR)',
    description: 'Mean Time to Recovery (MTTR) is a key performance metric in DevOps that measures the average time it takes to restore a system or application to full functionality after a failure or incident. A lower MTTR indicates faster incident resolution and better system reliability.',
    reference: 'https://www.atlassian.com/incident-management/kpis/mean-time-to-recovery-mttr',
  },

  {
    term: 'Ingress Controller',
    description: 'An Ingress Controller is a component in Kubernetes that manages external access to services within the cluster. It acts as a reverse proxy and allows for routing and load balancing of incoming traffic to different services.',
    reference: 'https://kubernetes.io/docs/concepts/services-networking/ingress/',
  },

  {
    term: 'Prometheus Monitoring',
    description: 'Prometheus is an open-source monitoring and alerting toolkit used to collect and store metrics from applications and infrastructure. It offers a powerful query language and visualization tools for monitoring DevOps environments.',
    reference: 'https://prometheus.io/docs/introduction/overview/',
  },

  {
    term: 'Horizontal Pod Autoscaling (HPA)',
    description: 'Horizontal Pod Autoscaling (HPA) is a Kubernetes feature that automatically adjusts the number of pods in a deployment or replica set based on CPU or custom metrics. It ensures optimal resource utilization and application performance.',
    reference:'https://kubernetes.io/docs/tasks/run-application/horizontal-pod-autoscale/',
  },

  {
    term: 'Kubernetes StatefulSet',
    description: 'Kubernetes StatefulSet is a workload API object used for managing stateful applications in Kubernetes clusters. It provides guarantees about the order and uniqueness of pods, making it suitable for databases and other stateful services.',
    reference: 'https://kubernetes.io/docs/concepts/workloads/controllers/statefulset/',
  },

  {
    term: 'Kubeconfig',
    description: 'Kubeconfig is a configuration file that contains authentication and cluster information for connecting to a Kubernetes cluster. DevOps teams use kubeconfig files to access and manage Kubernetes clusters.',
    reference: 'https://kubernetes.io/docs/concepts/configuration/organize-cluster-access-kubeconfig/',
  },

  {
    term: 'StatefulSet',
    description: 'A StatefulSet is a workload API object in Kubernetes designed for managing stateful applications. It provides guarantees about the ordering and uniqueness of Pods, making it suitable for databases and other stateful services.',
    reference: 'https://kubernetes.io/docs/concepts/workloads/controllers/statefulset/',
  },

  {
    term: 'Service',
    description: 'Kubernetes Services provide an abstraction for routing traffic to a group of Pods. Services enable load balancing and make it possible to access applications consistently within the cluster.',
    reference: 'https://kubernetes.io/docs/concepts/services-networking/service/',
  },

  {
    term: 'Helm',
    description: 'Helm is a package manager for Kubernetes that simplifies the deployment and management of applications. It allows you to define, install, and upgrade even the most complex Kubernetes applications.',
    reference: 'https://helm.sh/',
  },

  {
    term: 'Pod',
    description: 'In Kubernetes, a Pod is the smallest deployable unit that can contain one or more containers. Pods are used to encapsulate and manage containers within the cluster.',
    reference: 'https://kubernetes.io/docs/concepts/workloads/pods/',
  },

  {
    term: 'OpenStack',
    description: 'OpenStack is an open-source platform designed for building on-premises cloud infrastructures. It provides a set of software tools and components for creating and managing private and public cloud environments. OpenStack enables organizations to deploy and manage scalable and flexible cloud services within their own data centers.',
    reference: 'https://www.openstack.org/',
  },
];
